...
//    HAL_usbserial_init2(false, true, 0x6141);        // Start USB serial not using interrupts
    HAL_usbserial_init2(false, false, 0x6141);        // Start USB serial not using interrupts **tomo
...
//	unsigned short adcdata=12;
	
//	HAL_ADC_Init(0,1);
//	HAL_ADC_StartConversion();
//	HAL_ADC_GetData(&adcdata);
	
//	dbg_str_int("audio", adcdata);
